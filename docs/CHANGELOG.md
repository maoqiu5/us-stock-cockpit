...
## 2026-07-25 - BrianHub 文档标准化

- 类型：文档 / 规范
- 背景：门户文档中心已建立跨项目文档体检规则，美股项目需要继续保持 `README / PRD / DEPLOYMENT / CHANGELOG` 标准四件套清晰可读，并减少疑似密钥扫描误报。
- 变更：
  - 重建 `docs/README.md`，明确标准文档、专题文档、跨项目规则、根目录文档关系和敏感信息边界。
  - 优化 `docs/DEPLOYMENT.md`，把环境变量从赋值示例改成变量名和用途清单，补充 BrianHub SSO 长期边界、回滚流程和数据目录边界。
  - 优化 `docs/AI_RESUME_CONTEXT.md`，移除赋值式环境变量示例，保留接手所需变量名和用途。
  - 保留 `docs/PRD.md`、`docs/PROJECT_HANDOFF.md`、`docs/2026-07-23-long-term-watchlist-strategy.md` 等当前有效文档，不做大规模删除。
- 验证：
  - 对照 Codex 会话 `rollout-2026-07-21T22-33-26-019f8518-8bfe-7f22-8f5b-509b3745c6cb.jsonl` 提取近期有效结论。
  - 本地文档检查确认标准四件套存在，新增内容未写入真实密码、API Key、Cookie、内部令牌或券商私钥。
